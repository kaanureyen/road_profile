...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **FMI Simulation (Wheel 1-4)** | `42` | `2` (Class B) | *Default (Inactive)* | `2.0` | `0.01` | `2.0` | `512` | `32` |
| **FMI Simulation (Sensitivity)** | `99` | `2` (Class B) | *Default (Inactive)* | `2.0` | `0.01` | `2.0` | `512` | `32` |
| **Distance Homogeneity** | `dist + slice_idx + 2026` | `0` (Custom) | `64e-6` | `2.0` | `0.01` | `2.0` | `512` | `32` |
| **Parameter Fitting (Case 1)** | `200 + slice_idx` | `0` (Custom) | `64e-6` | `2.0` | `0.01` | `2.0` | `512` | `32` |
| **Parameter Fitting (Case 2)** | `201 + slice_idx` | `0` (Custom) | `256e-6` | `1.8` | `0.01` | `2.0` | `512` | `32` |
| **Parameter Fitting (Case 3)** | `202 + slice_idx` | `0` (Custom) | `1024e-6` | `2.2` | `0.01` | `2.0` | `512` | `32` |
| **PSD Comparison** | `42` | `0` (Custom) | `64e-6` | `2.0` | `0.01` | `2.0` | `512` | `32` |
| **Terrain Elevation Plot** | `42` | `3` (Class C) | *Default (Inactive)* | `2.0` | `0.01` | `2.0` | `512` | `32` |
