...
## 7. FFT Amplitude Spectrum (0.002 - 2000 Hz)
This test validates the raw frequency amplitude spectrum of the road profile generated by the FMU across the entire range of $0.002\text{ to }2000.0\text{ cycles/m (Hz)}$. 
- The linear plot (left) shows the distribution of discrete sinusoid wave amplitudes.
- The log-log plot (right) shows the amplitude decay following the target theoretical slope of $A \sim f^{-w/2} = f^{-1.0}$.
...
![FFT Amplitude Spectrum 0.002 - 2000 Hz](psd_amplitude_frequency.png)

---

## 8. Isotropic 2D Terrain Elevation Map (500m x 500m)
This test generates a full 2D terrain elevation profile covering a $500\text{m} \times 500\text{m}$ area for visual validation of the continuous 2D road surface.
