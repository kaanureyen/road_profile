...
2. **Exact Isotropic Cumulative Model**: The mathematically exact cumulative power projection model including the low-frequency band-limit $f_{\min} = 0.002$ cycles/m:
